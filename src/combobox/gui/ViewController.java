...
public class ViewController implements Initializable {
	...
	// Anotação para fazer associação com a interface gráfica
	@FXML
	...
	// ObservableList - tipo especial de lista que já fica associado ao componente
	// visual, implementa uma interação entre a interface gráfica(componente) e a
	// coleção(lista)
